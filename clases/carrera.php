<?php
require_once('clases' . DIRECTORY_SEPARATOR . 'kits.php');
require_once('clases' . DIRECTORY_SEPARATOR . 'participanteManager.php');
...
class Carrera {
    ...
    //Imprime por pantalla los datos de una carrera
	...
	//Imprime por pantalla los resultados de la carrera    
    public function mostrarResultado($atletas){
